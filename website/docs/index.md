...
hero:
  name: MDEO Cloud
  text: Model-driven engineering optimisation in the browser
  tagline: A distributed platform whose every language, editor and analysis is a plugin — including the ones it ships with.
  image:
    src: /logo.svg
    alt: MDEO Cloud
  actions:
    - theme: brand
      text: What is MDEO Cloud?
      link: /guide/
    - theme: alt
